	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		/*if (evaluadoresArray.length < 2) {
			...
			String content = "Hola investigador/a.\r\n\r\n"
					+ "La solicitud con id "+  req.getParameter("id") +" se ha abierto correctamente, y ha sido enviada para su evaluaci�n.\r\n\r\n"
					+ "-----------------------------------------------\r\n"
			...
			String content2 = "Hola evaluador/a.\r\n\r\n"
					...
					+ "Acceda al portal web para proceder con su evaluaci�n.\r\n\r\n"
					+ "-----------------------------------------------\r\n"
					+ "Este correo ha sido generado autom�ticamente.\r\n" 
					+"No responda a este correo, este buz�n autom�tico no es revisado.\r\n" 
					+"Para revisar sus solicitudes, por favor, rev�selas v�a web.";

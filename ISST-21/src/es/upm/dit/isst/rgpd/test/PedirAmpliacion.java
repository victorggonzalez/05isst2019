...
public class PedirAmpliacion {
  ...
  public void setUp() {
	...
	e2.setName("evaluador1");
	e2.setEmail("e1@upm.es");
	e2.setArea("area1");
	e2.setGrupo("grupo2");
  ...
  public void PedirAmpliacion() {
    ...
    driver.findElement(By.name("faltandatos")).click();
    driver.findElement(By.name("faltandatos")).sendKeys("Faltan todos los datos");
    ...
    driver.findElement(By.name("password")).sendKeys("pass");
    driver.findElement(By.cssSelector(".button")).click();
    driver.findElement(By.linkText("Pendiente de ampliación")).click();
    driver.findElement(By.cssSelector(".small")).click();
    driver.findElement(By.cssSelector(".box")).click();
    assertThat(driver.findElement(By.cssSelector("p:nth-child(2)")).getText(), is("Faltan todos los datos"));
    driver.findElement(By.linkText("Log out")).click();
  }
}
